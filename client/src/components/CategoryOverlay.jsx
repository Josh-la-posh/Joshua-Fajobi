...
class CategoryOverlay extends PureComponent {
  ...
  render() {
    const { addToCart, removeFromCart, cart, currency, totalQuantity, toggle } =
      this.props;
      ...
      <div className="overlay">
        ...
        <div className="categoryOverlay">
                  ...
                  <section className="flex" key={index}>
                    <div className="leftContent flex col font-16">
                      ...
                      {attributes?.map(({ name, type, items }, index) => {
                        return (
                          <div
                            key={index}
                            className="size flex col font-14 weight-400"
                          >
                            <span>{name}:</span>
                            <div
                              className={
                    ...
                    <div className="rightContent flex">
                      <div className="button flex-btw-align col">
                        <button
                          className="add flex-center font-14"
                          onClick={() =>
                            addToCart(
                              id,
                              gallery,
                        ...
                        <button
                          className="minus flex-center font-14"
                          onClick={() => {
                            removeFromCart(index);
                          }}
                        >
          ...
          <div className="button flex-align font-14 weight-600">
            <Link to="/scandiweb/cart">
              <button className="view" onClick={toggle}>
                VIEW BAG
              </button>
            </Link>
